    ...
    ) : IDelegateInvoker<TIn1, TIn2, TIn3, TIn4, TResult>
    {
        ...
        public async Task<TResult> Invoke(TIn1 input1, TIn2 input2, TIn3 input3, TIn4 input4)
            => await _func(
                _paramBuilder1(input1, input2, input3, input4),
                _paramBuilder2(input1, input2, input3, input4),
                _paramBuilder3(input1, input2, input3, input4)
            );
    }
    ...
    ) : IDelegateInvoker<TIn1, TIn2, TIn3, TIn4, TResult>
    {
        ...
        public async Task<TResult> Invoke(TIn1 input1, TIn2 input2, TIn3 input3, TIn4 input4)
            => await _func(
                ...
                _paramBuilder2(input1, input2, input3, input4),
                _paramBuilder3(input1, input2, input3, input4),
                _paramBuilder4(input1, input2, input3, input4)
            );
    }
    ...
    ) : IDelegateInvoker<TIn1, TIn2, TIn3, TIn4, TResult>
    {
        ...
        public async Task<TResult> Invoke(TIn1 input1, TIn2 input2, TIn3 input3, TIn4 input4)
            => await _func(
                ...
                _paramBuilder3(input1, input2, input3, input4),
                _paramBuilder4(input1, input2, input3, input4),
                _paramBuilder5(input1, input2, input3, input4)
            );
    }
    ...
    ) : IDelegateInvoker<TIn1, TIn2, TIn3, TIn4, TResult>
    {
        ...
        public async Task<TResult> Invoke(TIn1 input1, TIn2 input2, TIn3 input3, TIn4 input4)
            => await _func(
                ...
                _paramBuilder4(input1, input2, input3, input4),
                _paramBuilder5(input1, input2, input3, input4),
                _paramBuilder6(input1, input2, input3, input4)
            );
    }
    ...
    ) : IDelegateInvoker<TIn1, TIn2, TIn3, TIn4, TResult>
    {
        ...
        public async Task<TResult> Invoke(TIn1 input1, TIn2 input2, TIn3 input3, TIn4 input4)
            => await _func(
                ...
                _paramBuilder5(input1, input2, input3, input4),
                _paramBuilder6(input1, input2, input3, input4),
                _paramBuilder7(input1, input2, input3, input4)
            );
    }
    ...
    ) : IDelegateInvoker<TIn1, TIn2, TIn3, TIn4, TResult>
    {
        ...
        public async Task<TResult> Invoke(TIn1 input1, TIn2 input2, TIn3 input3, TIn4 input4)
            => await _func(
                ...
                _paramBuilder6(input1, input2, input3, input4),
                _paramBuilder7(input1, input2, input3, input4),
                _paramBuilder8(input1, input2, input3, input4)
            );
    }
    ...
    ) : IDelegateInvoker<TIn1, TIn2, TIn3, TIn4, TResult>
    {
        ...
        public async Task<TResult> Invoke(TIn1 input1, TIn2 input2, TIn3 input3, TIn4 input4)
            => await _func(
                ...
                _paramBuilder7(input1, input2, input3, input4),
                _paramBuilder8(input1, input2, input3, input4),
                _paramBuilder9(input1, input2, input3, input4)
            );
    }
}